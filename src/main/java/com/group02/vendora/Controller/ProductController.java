...
import com.group02.vendora.dto.ProductDto;
import com.group02.vendora.service.ProductService;
...
public class ProductController {
    ...
    private final com.group02.vendora.service.ProductService productService;
    ...
    public ResponseEntity<ProductDto.Response> getProduct(@PathVariable Long id) {
        return ResponseEntity.ok(com.group02.vendora.service.ProductService.getProductById(id));
    }
